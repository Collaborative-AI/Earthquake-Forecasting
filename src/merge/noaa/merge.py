...
csv_files = ["src/merge/noaa/input/GHEA.csv",
             "src/merge/noaa/input/NCEI.csv",
             "src/merge/noaa/input/NOAA.csv"]
...
result_df.to_csv("src/merge/noaa/NOAA-Combined.csv", index=False)
