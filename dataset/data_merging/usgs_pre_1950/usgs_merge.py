...
import sys
sys.path.append("dataset/data_merging")

import pandas as pd

# 1. Load all files to merge
csv_files = ["dataset/data_merging/usgs_pre_1950/input/USGS1800-1849.csv",
             "dataset/data_merging/usgs_pre_1950/input/USGS1850-1899.csv",
             "dataset/data_merging/usgs_pre_1950/input/USGS1900-1949.csv"]
...
result_df.to_csv("dataset/data_merging/usgs_pre_1950/USGS1800-1949.csv", index=False)
