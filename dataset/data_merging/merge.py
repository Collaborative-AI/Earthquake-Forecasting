...
The output dataset will be found in the dataset/data_merging/ folder, and the
...
SCRAPER_PATH = "dataset/data_processing/processed"
...
"""
output_path = "dataset/data_merging/Various-Catalogs.csv"
