...
if __name__ == "__main__":
    input_path = "dataset/data_scraping/Argentina/raw/clean-catalog.xml"
    output_path = "dataset/data_scraping/Argentina/clean/Argentina Andean Earthquakes (2016-2017).csv"
