...
if __name__ == "__main__":
    input_path = "dataset/data_scraping/Pacific Northwest/raw/pacific-northwest-tremors-2009-2024.csv"
    
    output_filename = "PNW Tremors (2009-2023)"
    output_path = f"dataset/data_scraping/Pacific Northwest/clean/{output_filename}.csv"
