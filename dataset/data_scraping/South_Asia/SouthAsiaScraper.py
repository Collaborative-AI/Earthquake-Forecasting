...
import sys
sys.path.append("dataset/data_scraping")
...
# main method that calls the web data_scraping function
if __name__ == "__main__":
    input_path = "dataset/data_scraping/South Asia/raw/11069_2016_2665_MOESM2_ESM.csv"
    
    output_filename = "South Asia (1900-2014)"
    output_path = f"dataset/data_scraping/South Asia/clean/{output_filename}.csv"
